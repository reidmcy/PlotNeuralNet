...
arch = [
    ...
    *invisible_box_2( name='invisible_1', botton='conv_block1_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 9}}'),
    ...
    *invisible_box_2( name='invisible_2', botton='res_0_add_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 8}}'),
    
    *block_Res_2( name='res_1', botton='invisible_2', s_filer=8, n_filer=64, offset="(2,0,0)", width=2, height=35, depth=35, opacity=0.5),
    *invisible_box_2( name='invisible_3', botton='res_1_add_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 7}}'),
    
    *block_Res_2( name='res_2', botton='invisible_3', s_filer=8, n_filer=64, offset="(2,0,0)", width=2, height=35, depth=35, opacity=0.5),
    *invisible_box_2( name='invisible_4', botton='res_2_add_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 6}}'),
    
    *block_Res_2( name='res_3', botton='invisible_4', s_filer=8, n_filer=64, offset="(2,0,0)", width=2, height=35, depth=35, opacity=0.5),
    *invisible_box_2( name='invisible_5', botton='res_3_add_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 5}}'),
    
    *block_Res_2( name='res_4', botton='invisible_5', s_filer=8, n_filer=64, offset="(2,0,0)", width=2, height=35, depth=35, opacity=0.5),
    *invisible_box_2( name='invisible_6', botton='res_4_add_relu', offset="(1.5,0,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 4}}'),
    
    *block_Res_2( name='res_5', botton='invisible_6', s_filer=8, n_filer=64, offset="(2,0,0)", width=2, height=35, depth=35, opacity=0.5),
    *invisible_box_3( name='invisible_7', botton='res_5_add_relu', offset="(1.5,4.5,0)", width=1, height=13, depth=13, opacity=0, caption='\makebox[12pt]{\shortstack[c]{Gradient Stop \\\ Location 3}}'),
